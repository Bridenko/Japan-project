window.addEventListener('DOMContentLoaded', () => {
    ...
    (function () {
        ...
        window.onscroll = () => {
            ...
            if (window.pageYOffset > 20) {
                header.classList.add('js-item-border-opacity-25');
            } else {
                header.classList.remove('js-item-border-opacity-25');
            }

            if (window.pageYOffset > 40) {
                header.classList.add('js-item-border-opacity-50');
            } else {
                header.classList.remove('js-item-border-opacity-50');
            }
        };
    }());
